...
describe('test internalorder apis', () => {
    ...
    before(async () => {
        ...
        internalOrder.storeInternalOrder(order2)
        internalOrder.storeInternalOrder(order3)
        internalOrder.storeInternalOrderProduct(order1product1)
        internalOrder.storeInternalOrderProduct(order1product2)
        internalOrder.storeInternalOrderProduct(order2product1)
        internalOrder.storeInternalOrderProduct(order2product2)
        internalOrder.storeInternalOrderProduct(order3product1)
