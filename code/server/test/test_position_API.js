...
describe('test position apis', () => {
    ...
    storePosition(201, position3); //position3 inserito

    storePosition(422, wrongPosID); //FORMATO SBAGLIATO ==> ERRORE
    storePosition(422, wrongPosFields); //FORMATO SBAGLIATO ==> ERRORE

    getMultiplePositions(200, [position1get, position2get, position3get]); //position1 position2 position3 ritornati
    ...
    deletePosition(204, deletePos); //elimino position3
...
function modifyPosID(expectedHTTPStatus, data) {
